...
/// @notice Simple ERC20 + EIP-2612 implementation with transient storage.
/// @author Modified from Solmate (https://github.com/transmissions11/solmate/blob/main/src/tokens/ERC20.sol)
/// @author Modified from OpenZeppelin (https://github.com/OpenZeppelin/openzeppelin-contracts/blob/master/contracts/token/ERC20/ERC20.sol)
abstract contract TransientERC20 {
    ...
    function _transientApprovalLocation(address owner, address spender) internal virtual returns (bytes32 location) {
        location = keccak256(
            abi.encode(
                spender,
                keccak256(abi.encode(owner, uint256(TRANSIENT_APPROVAL_SLOT)))
            )
        );
    }
}